...
RUN curl -sL https://github.com/hbagdi/deck/releases/download/v0.6.0/deck_0.6.0_linux_amd64.tar.gz -o deck.tar.gz && tar -xf deck.tar.gz -C . && cp deck /usr/local/bin/ && chmod +x /usr/local/bin/deck
